...
import RegisterCompanyTwo from "@/components/registerCompany/registerTwo";

const PageRegisterCompanyTwo = () => {
  return (
    <>
      <header>
        <HeaderLogin />
        ...
        <div className="flex flex-col items-center justify-center px-4 py-12 sm:py-16">
          <div className="text-center mb-8 max-w-2xl">
            ...
            <p className="text-lg text-gray-700 mt-4 font-SecondFont">
              Só mais um passo pra sua empresa entrar na plataforma
            </p>
          </div>
...
export default PageRegisterCompanyTwo;
