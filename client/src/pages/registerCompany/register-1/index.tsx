...
import RegisterCompanyOne from "@/components/registerCompany/registerOne";

const PageRegisterCompanyOne = () => {
  return (
    <>
      <header>
        <HeaderLogin />
        ...
        <div className="flex flex-col items-center justify-center px-4 py-12 sm:py-16">
          <div className="text-center mb-8 max-w-2xl">
            ...
            <p className="text-lg text-gray-700 mt-4 font-SecondFont">
              Cadastre sua empresa e encontre os melhores talentos do agronegócio
            </p>
          </div>
...
export default PageRegisterCompanyOne;
